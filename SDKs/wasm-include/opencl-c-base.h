...
#define CLK_AVC_ME_SKIP_BLOCK_16x16_SUGOI_ENABLE_INTEL (0x3 << 24)
#define CLK_AVC_ME_SKIP_BLOCK_8x8_FORWARD_ENABLE_INTEL (0x55 << 24)
#define CLK_AVC_ME_SKIP_BLOCK_8x8_BACKWARD_ENABLE_INTEL (0xAA << 24)
#define CLK_AVC_ME_SKIP_BLOCK_8x8_SUGOI_ENABLE_INTEL (0xFF << 24)
...
#define CLK_AVC_ME_FRAME_SUGOI_INTEL 0x3
...
#define CLK_AVC_IME_RESULT_SUGOI_REFERENCE_STREAMOUT_INITIALIZE_INTEL 0x0
#define CLK_AVC_IME_RESULT_SUGOI_REFERENCE_STREAMIN_INITIALIZE_INTEL 0x0
