...
elseif(WASI)
    ...
    set(SAKURA_TARGET_PLATFORM "wasi")
    set(TARGET_WA 1)   
...
if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    ...
    set(CLANG_DISABLED_WARNINGS "${CLANG_DISABLED_WARNINGS} -Wno-nullability-completeness -Wno-tautological-undefined-compare")
    set(CLANG_DISABLED_WARNINGS "${CLANG_DISABLED_WARNINGS} -Wno-switch -Wno-misleading-indentation -Wno-unused-parameter")
    if(NOT WASI)
        set(CLANG_PROMOTED_WARNINGS "${CLANG_PROMOTED_WARNINGS} -Werror=return-type")
    endif()
    set(CLANG_PROMOTED_WARNINGS "${CLANG_PROMOTED_WARNINGS} -Werror=incompatible-function-pointer-types")
...
elseif(MSVC)
    set(MSVC_FLAGS "${MSVC_FLAGS} /MP")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${MSVC_FLAGS}")
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${MSVC_FLAGS} /std:c17 /Zc:preprocessor")
endif()