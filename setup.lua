...
if (os.host() == "windows") then
    ...
    find_sdk.tool_from_github("meta-v1.0.1-llvm_17.0.6", "meta-v1.0.0-llvm_17.0.6-windows-x64.zip")
...
if (os.host() == "macosx") then
    if (os.arch() == "x86_64") then
        ...
        find_sdk.tool_from_github("meta-v1.0.1-llvm_17.0.6", "meta-v1.0.0-llvm_17.0.6-macosx-arm64.zip")
        -- dcc sdk
