...
#endif
{
    ...
    constexpr XMMATRIX(FXMVECTOR R0, FXMVECTOR R1, FXMVECTOR R2, CXMVECTOR R3) noexcept
        : r{ R0, R1, R2, R3 }
    {
    }
...
struct XMFLOAT2 {
    ...
    constexpr XMFLOAT2(float _x, float _y) noexcept
        : x(_x)
        , y(_y)
    {
    }
...
XMFLOAT2A : public XMFLOAT2
{
    ...
    constexpr XMFLOAT2A(float _x, float _y) noexcept
        : XMFLOAT2(_x, _y)
    {
    }
    explicit XMFLOAT2A(_In_reads_(2) const float* pArray) noexcept
        : XMFLOAT2(pArray)
    {
    }
};
...
struct XMINT2 {
    ...
    constexpr XMINT2(int32_t _x, int32_t _y) noexcept
        : x(_x)
        , y(_y)
    {
    }
...
struct XMUINT2 {
    ...
    constexpr XMUINT2(uint32_t _x, uint32_t _y) noexcept
        : x(_x)
        , y(_y)
    {
    }
...
XMFLOAT3A : public XMFLOAT3
{
    ...
    constexpr XMFLOAT3A(float _x, float _y, float _z) noexcept
        : XMFLOAT3(_x, _y, _z)
    {
    }
    explicit XMFLOAT3A(_In_reads_(3) const float* pArray) noexcept
        : XMFLOAT3(pArray)
    {
    }
};
...
XMFLOAT4A : public XMFLOAT4
{
    ...
    constexpr XMFLOAT4A(float _x, float _y, float _z, float _w) noexcept
        : XMFLOAT4(_x, _y, _z, _w)
    {
    }
    explicit XMFLOAT4A(_In_reads_(4) const float* pArray) noexcept
        : XMFLOAT4(pArray)
    {
    }
};
...
struct XMUINT4 {
    ...
    constexpr XMUINT4(uint32_t _x, uint32_t _y, uint32_t _z, uint32_t _w) noexcept
        : x(_x)
        , y(_y)
        , z(_z)
        , w(_w)
...
XMFLOAT4X3A : public XMFLOAT4X3
{
    ...
    explicit XMFLOAT4X3A(_In_reads_(12) const float* pArray) noexcept
        : XMFLOAT4X3(pArray)
    {
    }
};
...
XMFLOAT3X4A : public XMFLOAT3X4
{
    ...
    explicit XMFLOAT3X4A(_In_reads_(12) const float* pArray) noexcept
        : XMFLOAT3X4(pArray)
    {
    }
};
...
XMFLOAT4X4A : public XMFLOAT4X4
{
    ...
    explicit XMFLOAT4X4A(_In_reads_(16) const float* pArray) noexcept
        : XMFLOAT4X4(pArray)
    {
    }
};
...
_Success_(return ) bool XM_CALLCONV XMMatrixDecompose(_Out_ XMVECTOR* outScale, _Out_ XMVECTOR* outRotQuat, _Out_ XMVECTOR* outTrans, _In_ FXMMATRIX M) noexcept;
...
template <>
inline constexpr XMVECTOR XM_CALLCONV XMVectorPermute<0, 1, 2, 3>(FXMVECTOR V1, FXMVECTOR) noexcept { return V1; }
template <>
inline constexpr XMVECTOR XM_CALLCONV XMVectorPermute<4, 5, 6, 7>(FXMVECTOR, FXMVECTOR V2) noexcept { return V2; }

#if defined(_XM_SSE_INTRINSICS_) && !defined(_XM_NO_INTRINSICS_)
template <>
inline XMVECTOR XM_CALLCONV XMVectorPermute<0, 1, 4, 5>(FXMVECTOR V1, FXMVECTOR V2) noexcept
{
...
template <>
inline XMVECTOR XM_CALLCONV XMVectorPermute<4, 1, 2, 3>(FXMVECTOR V1, FXMVECTOR V2) noexcept
{
...
template <>
inline constexpr XMVECTOR XM_CALLCONV XMVectorSwizzle<0, 1, 2, 3>(FXMVECTOR V) noexcept { return V; }
