...
CIMGUI_API ImGuiID cimgui::ImGui_DockSpace(ImGuiID id)
{
    return ImGui::DockSpace(id);
}

CIMGUI_API ImGuiID cimgui::ImGui_DockSpaceEx(ImGuiID id, cimgui::ImVec2 size, ImGuiDockNodeFlags flags, const cimgui::ImGuiWindowClass* window_class)
{
    return ImGui::DockSpace(id, ConvertToCPP_ImVec2(size), flags, reinterpret_cast<const ::ImGuiWindowClass*>(window_class));
}
...
CIMGUI_API ImGuiID cimgui::ImGui_DockSpaceOverViewportEx(const cimgui::ImGuiViewport* viewport, ImGuiDockNodeFlags flags, const cimgui::ImGuiWindowClass* window_class)
{
    return ImGui::DockSpaceOverViewport(reinterpret_cast<const ::ImGuiViewport*>(viewport), flags, reinterpret_cast<const ::ImGuiWindowClass*>(window_class));
}
...
CIMGUI_API bool        cimgui::ImGui_IsKeyDown(ImGuiKey key)
{
    return ImGui::IsKeyDown(key);
}

CIMGUI_API bool        cimgui::ImGui_IsKeyPressed(ImGuiKey key)
{
    return ImGui::IsKeyPressed(key);
}

CIMGUI_API bool        cimgui::ImGui_IsKeyPressedEx(ImGuiKey key, bool repeat)
{
    return ImGui::IsKeyPressed(key, repeat);
}

CIMGUI_API bool        cimgui::ImGui_IsKeyReleased(ImGuiKey key)
{
    return ImGui::IsKeyReleased(key);
}

CIMGUI_API int         cimgui::ImGui_GetKeyPressedAmount(ImGuiKey key, float repeat_delay, float rate)
{
    return ImGui::GetKeyPressedAmount(key, repeat_delay, rate);
}

CIMGUI_API const char* cimgui::ImGui_GetKeyName(ImGuiKey key)
{
...
CIMGUI_API void cimgui::ImGuiIO_AddKeyEvent(cimgui::ImGuiIO* self, ImGuiKey key, bool down)
{
    reinterpret_cast<::ImGuiIO*>(self)->AddKeyEvent(key, down);
}

CIMGUI_API void cimgui::ImGuiIO_AddKeyAnalogEvent(cimgui::ImGuiIO* self, ImGuiKey key, bool down, float v)
{
    reinterpret_cast<::ImGuiIO*>(self)->AddKeyAnalogEvent(key, down, v);
}
...
CIMGUI_API void cimgui::ImGuiIO_SetKeyEventNativeData(cimgui::ImGuiIO* self, ImGuiKey key, int native_keycode, int native_scancode)
{
    reinterpret_cast<::ImGuiIO*>(self)->SetKeyEventNativeData(key, native_keycode, native_scancode);
}

CIMGUI_API void cimgui::ImGuiIO_SetKeyEventNativeDataEx(cimgui::ImGuiIO* self, ImGuiKey key, int native_keycode, int native_scancode, int native_legacy_index)
{
    reinterpret_cast<::ImGuiIO*>(self)->SetKeyEventNativeData(key, native_keycode, native_scancode, native_legacy_index);
}
...
CIMGUI_API int cimgui::GetKeyIndex(ImGuiKey key)
{
...
CIMGUI_API void  cimgui::ImGui_OpenPopupContextItem(const char* str_id, ImGuiMouseButton mb)
{
