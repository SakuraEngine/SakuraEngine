...
#define mi_atomic_fetch_add_relaxed(p,x)               mi_atomic(fetch_add_explicit)(p,x,mi_memory_order(relaxed))
...
#define mi_atomic_increment_relaxed(p)           mi_atomic_fetch_add_relaxed(p,(uintptr_t)1)
