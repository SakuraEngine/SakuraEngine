...
SKR_ANIM_API void skr_init_anim_component(skr_render_anim_comp_t* component, skr_mesh_resource_t* mesh, skr_skeleton_resource_t* skeleton);

SKR_ANIM_API void skr_cpu_skin(skr_render_skin_comp_t* skin, skr_render_anim_comp_t* anim, skr_mesh_resource_t* mesh);