...
[[nodiscard]] constexpr ochar8_t get_utf8_mask(const u64 length) noexcept
{
    constexpr ochar8_t masks[] = {
        static_cast<ochar8_t>(0b00111111),
        static_cast<ochar8_t>(0b01111111),
        static_cast<ochar8_t>(0b00011111),
        static_cast<ochar8_t>(0b00001111),
        static_cast<ochar8_t>(0b00000111),
    };
    return masks[length];
}
...
[[nodiscard]] constexpr u8 parse_utf8_length(const ochar8_t c) noexcept
{
    if (c == 0)
        return 1;
    constexpr ochar8_t mask = static_cast<ochar8_t>(0b10000000);
    u8                 size = 0;
    u8                 v    = c;
    while (v & mask)
    {
...
{
    if (utf32 <= get_utf8_maximum_codepoint(1)) return { static_cast<ochar8_t>(utf32),
                                                         0, 0, 0 };
    if (utf32 <= get_utf8_maximum_codepoint(2)) return { static_cast<ochar8_t>((utf32 >> 6) | 0xc0),
                                                         static_cast<ochar8_t>((utf32 & 0x3f) | 0x80),
                                                         0, 0 };
    if (utf32 <= get_utf8_maximum_codepoint(3)) return { static_cast<ochar8_t>((utf32 >> 12) | 0xe0),
                                                         static_cast<ochar8_t>(((utf32 >> 6) & 0x3f) | 0x80),
                                                         static_cast<ochar8_t>((utf32 & 0x3f) | 0x80),
                                                         0 };
    return { static_cast<ochar8_t>((utf32 >> 18) | 0xf0),
