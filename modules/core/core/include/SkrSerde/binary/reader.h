...
struct SKR_STATIC_API ReadTrait<int8_t> {
    static int Read(skr_binary_reader_t* reader, int8_t& value);
    static int Read(skr_binary_reader_t* reader, int8_t& value, IntegerPackConfig<int8_t>);
};
template <>
struct SKR_STATIC_API ReadTrait<int16_t> {
    static int Read(skr_binary_reader_t* reader, int16_t& value);
    static int Read(skr_binary_reader_t* reader, int16_t& value, IntegerPackConfig<int16_t>);
};
template <>
