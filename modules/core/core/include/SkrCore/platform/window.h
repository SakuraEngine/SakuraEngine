...
SKR_CORE_API void skr_get_all_monitors(uint32_t* count, SMonitorHandle* monitors);
SKR_CORE_API void skr_monitor_get_extent(SMonitorHandle monitor, int32_t* width, int32_t* height);
...
SKR_CORE_API void skr_window_set_position(SWindowHandle window, int32_t x, int32_t y);
SKR_CORE_API void skr_window_get_extent(SWindowHandle window, int32_t* width, int32_t* height);
SKR_CORE_API void skr_window_get_position(SWindowHandle window, int32_t* x, int32_t* y);
SKR_CORE_API bool skr_window_is_minimized(SWindowHandle window);
SKR_CORE_API bool skr_window_is_focused(SWindowHandle window);

SKR_CORE_API SWindowHandle skr_get_mouse_focused_window();
SKR_CORE_API void* skr_window_get_native_handle(SWindowHandle window);
SKR_CORE_API void* skr_window_get_native_view(SWindowHandle window);
SKR_CORE_API void skr_free_window(SWindowHandle window);
