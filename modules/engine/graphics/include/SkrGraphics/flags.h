...
typedef enum ECGPUResourceType
{
    ...
    CGPU_RESOURCE_TYPE_ACCELERATION_STRUCTURE = (CGPU_RESOURCE_TYPE_RENDER_TARGET_DEPTH_SLICES << 1),
#if defined(CGPU_USE_VULKAN)
    /// Subpass input (descriptor type only available in Vulkan)
    CGPU_RESOURCE_TYPE_INPUT_ATTACHMENT = (CGPU_RESOURCE_TYPE_ACCELERATION_STRUCTURE << 1),
    ...
    CGPU_RESOURCE_TYPE_ARGUMENT_BUFFER = (CGPU_RESOURCE_TYPE_ACCELERATION_STRUCTURE << 1),
