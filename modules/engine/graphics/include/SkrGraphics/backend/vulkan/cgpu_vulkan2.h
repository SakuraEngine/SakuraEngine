...
// StateBuffer APIs
CGPU_API CGPUStateBufferId cgpu_create_state_buffer_vulkan(CGPUCommandBufferId cmd, const struct CGPUStateBufferDescriptor* desc);
CGPU_API void cgpu_render_encoder_bind_state_buffer_vulkan(CGPURenderPassEncoderId encoder, CGPUStateBufferId stream);
CGPU_API void cgpu_compute_encoder_bind_state_buffer_vulkan(CGPUComputePassEncoderId encoder, CGPUStateBufferId stream);
CGPU_API void cgpu_free_state_buffer_vulkan(CGPUStateBufferId stream);

// raster state encoder APIs
CGPU_API CGPURasterStateEncoderId cgpu_open_raster_state_encoder_vulkan(CGPUStateBufferId stream, CGPURenderPassEncoderId encoder);
CGPU_API void cgpu_close_raster_state_encoder_vulkan(CGPURasterStateEncoderId encoder);
// dynamic_state
...
CGPU_API CGPUUserStateEncoderId cgpu_open_user_state_encoder_vulkan(CGPUStateBufferId stream, CGPURenderPassEncoderId encoder);
CGPU_API void cgpu_close_user_state_encoder_vulkan(CGPUUserStateEncoderId encoder);

// EXPERIMENTAL binder APIs
CGPU_API CGPUBinderId cgpu_create_binder_vulkan(CGPUCommandBufferId cmd);
CGPU_API void cgpu_binder_bind_vertex_layout_vulkan(CGPUBinderId, const struct CGPUVertexLayout* layout);
CGPU_API void cgpu_binder_bind_vertex_buffer_vulkan(CGPUBinderId, uint32_t first_binding, uint32_t binding_count, const CGPUBufferId* buffers, const uint64_t* offsets, const uint64_t* sizes, const uint64_t* strides);
CGPU_API void cgpu_free_binder_vulkan(CGPUBinderId binder);
