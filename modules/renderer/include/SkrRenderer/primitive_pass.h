...
struct IPrimitiveRenderPass {
    ...
    virtual void on_update(SRendererId renderer, skr::render_graph::RenderGraph* renderGraph) = 0;
    virtual void post_update(SRendererId renderer, skr::render_graph::RenderGraph* renderGraph) = 0;
