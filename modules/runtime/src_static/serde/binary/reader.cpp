...
{
template <class T>
inline int ReadBitpacked(skr_binary_reader_t* reader, T& value, IntegerPackConfig<T> config)
{
...
inline int ReadBitpacked(skr_binary_reader_t* reader, T& value, VectorPackConfig<ScalarType> config)
{
...
int ReadTrait<int8_t>::Read(skr_binary_reader_t* reader, int8_t& value)
{
    return reader->read(&value, sizeof(value));
}
int ReadTrait<int8_t>::Read(skr_binary_reader_t* reader, int8_t& value, IntegerPackConfig<int8_t>)
{
    return ReadBitpacked(reader, value, IntegerPackConfig<int8_t>{});
}
int ReadTrait<int16_t>::Read(skr_binary_reader_t* reader, int16_t& value)
{
    return reader->read(&value, sizeof(value));
}
int ReadTrait<int16_t>::Read(skr_binary_reader_t* reader, int16_t& value, IntegerPackConfig<int16_t>)
{
    return ReadBitpacked(reader, value, IntegerPackConfig<int16_t>{});
}
int ReadTrait<int32_t>::Read(skr_binary_reader_t* reader, int32_t& value)
{
    return reader->read(&value, sizeof(value));
}
int ReadTrait<int32_t>::Read(skr_binary_reader_t* reader, int32_t& value, IntegerPackConfig<int32_t>)
{
    return ReadBitpacked(reader, value, IntegerPackConfig<int32_t>{});
}
int ReadTrait<int64_t>::Read(skr_binary_reader_t* reader, int64_t& value)
{
    return reader->read(&value, sizeof(value));
}
int ReadTrait<int64_t>::Read(skr_binary_reader_t* reader, int64_t& value, IntegerPackConfig<int64_t>)
{
    return ReadBitpacked(reader, value, IntegerPackConfig<int64_t>{});
}
int ReadTrait<uint8_t>::Read(skr_binary_reader_t* reader, uint8_t& value)
{
    return reader->read(&value, sizeof(value));
}
int ReadTrait<uint8_t>::Read(skr_binary_reader_t* reader, uint8_t& value, IntegerPackConfig<uint8_t>)
{
    return ReadBitpacked(reader, value, IntegerPackConfig<uint8_t>{});
}
int ReadTrait<uint16_t>::Read(skr_binary_reader_t* reader, uint16_t& value)
{
    return reader->read(&value, sizeof(value));
}
int ReadTrait<uint16_t>::Read(skr_binary_reader_t* reader, uint16_t& value, IntegerPackConfig<uint16_t>)
{
    return ReadBitpacked(reader, value, IntegerPackConfig<uint16_t>{});
}
int ReadTrait<uint32_t>::Read(skr_binary_reader_t* reader, uint32_t& value)
{
    return reader->read(&value, sizeof(value));
}
int ReadTrait<uint32_t>::Read(skr_binary_reader_t* reader, uint32_t& value, IntegerPackConfig<uint32_t>)
{
    return ReadBitpacked(reader, value, IntegerPackConfig<uint32_t>{});
}
int ReadTrait<uint64_t>::Read(skr_binary_reader_t* reader, uint64_t& value)
{
    return reader->read(&value, sizeof(value));
}
int ReadTrait<uint64_t>::Read(skr_binary_reader_t* reader, uint64_t& value, IntegerPackConfig<uint64_t>)
{
    return ReadBitpacked(reader, value, IntegerPackConfig<uint64_t>{});
}
int ReadTrait<float>::Read(skr_binary_reader_t* reader, float& value)
{
    return reader->read(&value, sizeof(value));
}
// int ReadTrait<float>::Read(skr_binary_reader_t* reader, float& value, FloatingPackConfig<float>)
// {
//     return ReadBitpacked(reader, value, FloatingPackConfig<float>{});
// }
int ReadTrait<double>::Read(skr_binary_reader_t* reader, double& value)
{
    return reader->read(&value, sizeof(value));
}
// int ReadTrait<double>::Read(skr_binary_reader_t* reader, double& value, FloatingPackConfig<double>)
// {
//     return ReadBitpacked(reader, value, FloatingPackConfig<double>{});
// }

// skr types
int ReadTrait<skr_float2_t>::Read(skr_binary_reader_t* reader, skr_float2_t& value)
{
    return reader->read(&value, sizeof(value));
}
...
int ReadTrait<skr_float3_t>::Read(skr_binary_reader_t* reader, skr_float3_t& value)
{
    return reader->read(&value, sizeof(value));
}
...
int ReadTrait<skr_float4_t>::Read(skr_binary_reader_t* reader, skr_float4_t& value)
{
    return reader->read(&value, sizeof(value));
}
...
int ReadTrait<skr_float4x4_t>::Read(skr_binary_reader_t* reader, skr_float4x4_t& value)
{
    return reader->read(&value, sizeof(value));
}
...
int ReadTrait<skr_rotator_t>::Read(skr_binary_reader_t* reader, skr_rotator_t& value)
{
    return reader->read(&value, sizeof(value));
}
...
int ReadTrait<skr_quaternion_t>::Read(skr_binary_reader_t* reader, skr_quaternion_t& value)
{
    return reader->read(&value, sizeof(value));
}
