...
namespace skr::lua
{
SKR_RUNTIME_API int               push_enum(lua_State* L, long long v);
SKR_RUNTIME_API long long         check_enum(lua_State* L, int index);
SKR_RUNTIME_API long long         opt_enum(lua_State* L, int index, long long def);
...
SKR_RUNTIME_API int                          push_unknown(lua_State* L, void* value, std::string_view tid);
SKR_RUNTIME_API int                          push_unknown_value(lua_State* L, const void* value, std::string_view tid, size_t size, copy_constructor_t copy_constructor, destructor_t destructor);
SKR_RUNTIME_API void*                        check_unknown(lua_State* L, int index, std::string_view tid);
SKR_RUNTIME_API int                          push_sptr(lua_State* L, const skr::SPtr<void>& value, std::string_view tid);
SKR_RUNTIME_API skr::SPtr<void> check_sptr(lua_State* L, int index, std::string_view tid);
SKR_RUNTIME_API int             push_sobjectptr(lua_State* L, const skr::SObjectPtr<SInterface>& value, std::string_view tid);
SKR_RUNTIME_API skr::SObjectPtr<SInterface> check_sobjectptr(lua_State* L, int index, std::string_view tid);
// TODO: how should we handle math operations in lua?
// SKR_RUNTIME_API int push_float2(lua_State* L, const skr_float2_t* float2);
// SKR_RUNTIME_API skr_float2_t check_float2(lua_State* L, int index);
// SKR_RUNTIME_API int push_float3(lua_State* L, const skr_float3_t* float3);
// SKR_RUNTIME_API skr_float3_t check_float3(lua_State* L, int index);
// SKR_RUNTIME_API int push_float4(lua_State* L, const skr_float4_t* float4);
// SKR_RUNTIME_API skr_float4_t check_float4(lua_State* L, int index);
