...
using UMap = container::SparseHashMapOld<container::SparseHashMapMemory<
K,                                             /*Key Type*/
V,                                             /*Value Type*/
...
using FixedUMap = container::SparseHashMapOld<container::FixedSparseHashMapMemory<
K,                                             /*Key Type*/
V,                                             /*Value Type*/
uint64_t,                                      /*BitBlock Type*/
container::KeyTraits<container::KVPair<K, V>>, /*Key Traits*/
...
using InlineUMap = container::SparseHashMapOld<container::InlineSparseHashMapMemory<
K,                                             /*Key Type*/
V,                                             /*Value Type*/
uint64_t,                                      /*BitBlock Type*/
container::KeyTraits<container::KVPair<K, V>>, /*Key Traits*/
