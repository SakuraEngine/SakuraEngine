    ...
    )
{
    ...
    md5->digest[0]  = (uint8_t)( Context->a );
    md5->digest[1]  = (uint8_t)( Context->a >> 8 );
    md5->digest[2]  = (uint8_t)( Context->a >> 16 );
    md5->digest[3]  = (uint8_t)( Context->a >> 24 );
    md5->digest[4]  = (uint8_t)( Context->b );
    md5->digest[5]  = (uint8_t)( Context->b >> 8 );
    md5->digest[6]  = (uint8_t)( Context->b >> 16 );
    md5->digest[7]  = (uint8_t)( Context->b >> 24 );
    md5->digest[8]  = (uint8_t)( Context->c );
    md5->digest[9]  = (uint8_t)( Context->c >> 8 );
    md5->digest[10] = (uint8_t)( Context->c >> 16 );
    md5->digest[11] = (uint8_t)( Context->c >> 24 );
    md5->digest[12] = (uint8_t)( Context->d );
    md5->digest[13] = (uint8_t)( Context->d >> 8 );
    md5->digest[14] = (uint8_t)( Context->d >> 16 );
    md5->digest[15] = (uint8_t)( Context->d >> 24 );
}

void skr_crypt_make_md5(const char* str, uint32_t str_size, skr_md5_t* out_md5)
{
    if (str == NULL) return;

    Md5Context context;
    Md5Initialise( &context );
    Md5Update( &context, str, str_size );
    Md5Finalise( &context, out_md5 );
}