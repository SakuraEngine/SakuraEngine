...
void SGDICanvasNVG::add_element(SGDIElement* element, const skr_float4x4_t& transform)
{
...
SGDIElement* SGDIDeviceNVG::create_element()
{
    ...
    auto nvg = nvgCreateInternal(&params);
    return SkrNew<SGDIElementNVG>(nvg);
}
...
void SGDIDeviceNVG::render(skr::render_graph::RenderGraph* rg, SGDICanvas* canvas)
{
