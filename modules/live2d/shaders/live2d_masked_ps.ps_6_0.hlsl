...
Texture2D mask_texture : register(t1, space0);
...
float4 main(VSOut input) : SV_TARGET
{
    ...
    float4 clip_mask = (1.0 - mask_texture.Sample(color_sampler, input.clip_pos.xy / input.clip_pos.w)) * push_constants.channel_flag;
