...
TEST_CASE_METHOD(RTTITests, "TypeId")
{
    ...
    auto guid1 = ::skr::rttr::type_id<Types::TestEnum>();

    static_assert(::skr::rttr::type_id<Types::TestEnum>() == u8"1a0b91c7-6690-41d6-acfd-0c2b61f181f3"_guid, "");
    const bool equal = guid0 == guid1;
    REQUIRE(equal);
    SKR_LOG_FMT_DEBUG(u8"u8 type id: {}", ::skr::rttr::type_id<uint32_t>());
    SKR_LOG_FMT_DEBUG(u8"TestEnum type id: {}", ::skr::rttr::type_id<Types::TestEnum>());
}
...
TEST_CASE_METHOD(RTTITests, "TestEnumType")
{
    ...
    auto type     = registry->get_type(::skr::rttr::type_id<Types::TestEnum>());
    auto enumType = static_cast<const skr::type::EnumType*>(type);
    REQUIRE(enumType != nullptr);
    EXPECT_EQ(enumType->guid, ::skr::rttr::type_id<Types::TestEnum>());
...
TEST_CASE_METHOD(RTTITests, "TestRecordType")
{
    ...
    EXPECT_EQ(recordType->GetGuid(), ::skr::rttr::type_id<Types::TestSon>());
