...
TEST_CASE("test intro sort")
{
    ...
    algo::intro_sort(increasing_begin, increasing_end);
    algo::intro_sort(decreasing_begin, decreasing_end);
    algo::intro_sort(random_begin, random_end);
