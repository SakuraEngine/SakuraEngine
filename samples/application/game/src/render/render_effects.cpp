...
{
    // initialize queries
    mesh_query = dualQ_from_literal(storage, "[in]game::ForwardEffectToken, [in]skr::renderer::MeshComponent");
    mesh_write_query = dualQ_from_literal(storage, "[inout]skr::renderer::MeshComponent");
    draw_mesh_query = dualQ_from_literal(storage, "[in]game::ForwardEffectToken, [in]skr::renderer::MeshComponent, [out]skr_render_group_t");
}
