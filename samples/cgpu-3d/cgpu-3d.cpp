...
int main(int argc, char* argv[])
{
    ...
    auto aux_thread = CreateAndInitialize<RenderAuxThread>(render_device.get());
    auto pso_aux_thread = CreateAndInitialize<RenderAuxThread>(render_device.get());
    auto async_transfer_thread = CreateAndInitialize<AsyncTransferThread>(render_device.get());
    ...
    {
        render_contexts_[i] = CreateAndInitialize<RenderContext>(render_device.get());
    }
