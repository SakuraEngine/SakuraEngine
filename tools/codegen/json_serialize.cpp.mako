...
const char* JsonFieldNotFoundErrorFormat = "[SERDE/JSON] %s.%s not found";
const char* JsonFieldNotFoundFormat = "[SERDE/JSON] %s.%s not found, using default value";

const char* JsonArrayFieldNotEnoughErrorFormat = "[SERDE/JSON] %s.%s has too few elements (%d expected, given %d)";
const char* JsonArrayFieldNotEnoughWarnFormat = "[SERDE/JSON] %s.%s got too few elements (%d expected, given %d), using default value";
const char* JsonBaseArchiveFailedFormat = "[SERDE/JSON] Archive %s base %s failed: %d";
