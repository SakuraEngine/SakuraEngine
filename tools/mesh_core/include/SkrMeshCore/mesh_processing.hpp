...
MESH_CORE_API
void EmplaceRawPrimitiveIndexBuffer(const SRawPrimitive* primitve, skr::Array<uint8_t>& buffer, skr_index_buffer_entry_t& out_ibv);
...
MESH_CORE_API
void EmplaceSkinRawMeshVertices(const SRawMesh* mesh, const CGPUVertexLayout* layout, skr::Array<uint8_t>& buffer, 
    uint32_t buffer_idx, skr::Array<skr_mesh_primitive_t>& out_primitives);

MESH_CORE_API
void EmplaceStaticRawMeshVertices(const SRawMesh* mesh, const CGPUVertexLayout* layout, skr::Array<uint8_t>& buffer, 
    uint32_t buffer_idx, skr::Array<skr_mesh_primitive_t>& out_primitives);
