...
void EmplaceRawPrimitiveIndexBuffer(const SRawPrimitive* primitve, skr::Array<uint8_t>& buffer, skr_index_buffer_entry_t& index_buffer)
{
...
void EmplaceRawPrimitiveVertexBufferAttribute(const SRawPrimitive* primitve, ERawVertexStreamType type, uint32_t idx, skr::Array<uint8_t>& buffer, skr_vertex_buffer_entry_t& out_vbv)
{
...
void EmplaceRawPrimitiveVertexBufferAttribute(const SRawPrimitive* primitve, const char* semantics, uint32_t idx, skr::Array<uint8_t>& buffer, skr_vertex_buffer_entry_t& out_vbv)
{
    skr::span<const uint8_t> vertex_attribtue_slice = {};
    uint32_t attribute_stride = 0;
...
void EmplaceAllRawMeshIndices(const SRawMesh* mesh, skr::Array<uint8_t>& buffer, skr::Array<skr_mesh_primitive_t>& out_primitives)
{
...
void EmplaceRawMeshVerticesWithRange(skr::span<const ESkrVertexAttribute> range, uint32_t buffer_idx,  const SRawMesh* mesh, 
    const CGPUVertexLayout* layout, skr::Array<uint8_t>& buffer, skr::Array<skr_mesh_primitive_t>& out_primitives)
{
    if (layout != nullptr)
    {
...
void EmplaceAllRawMeshVertices(const SRawMesh* mesh, const CGPUVertexLayout* layout, skr::Array<uint8_t>& buffer, skr::Array<skr_mesh_primitive_t>& out_primitives)
{
    EmplaceRawMeshVerticesWithRange(kRawAttributeTypeLUT, 0, mesh, layout, buffer, out_primitives);
}

void EmplaceSkinRawMeshVertices(const SRawMesh* mesh, const CGPUVertexLayout* layout, skr::Array<uint8_t>& buffer, uint32_t buffer_idx, skr::Array<skr_mesh_primitive_t>& out_primitives)
{
    EmplaceRawMeshVerticesWithRange(kRawSkinAttributes, buffer_idx, mesh, layout, buffer, out_primitives);
}

void EmplaceStaticRawMeshVertices(const SRawMesh* mesh, const CGPUVertexLayout* layout, skr::Array<uint8_t>& buffer, uint32_t buffer_idx, skr::Array<skr_mesh_primitive_t>& out_primitives)
{
