...
GLTFTOOL_API
void CookGLTFMeshData(const cgltf_data* data, SMeshCookConfig* config, skr_mesh_resource_t& out_resource, skr::Array<skr::Array<uint8_t>>& out_bins);

GLTFTOOL_API
void CookGLTFMeshData_SplitSkin(const cgltf_data* data, SMeshCookConfig* config, skr_mesh_resource_t& out_resource, skr::Array<skr::Array<uint8_t>>& out_bins);
}
}