...
GLTFTOOL_API
void EmplaceGLTFPrimitiveIndexBuffer(const cgltf_primitive* primitve, skr::vector<uint8_t>& buffer, skr_index_buffer_entry_t& out_ibv);

GLTFTOOL_API
void EmplaceGLTFPrimitiveVertexBufferAttribute(const cgltf_primitive* primitve, cgltf_attribute_type type, uint32_t idx, skr::vector<uint8_t>& buffer, skr_vertex_buffer_entry_t& out_vbv);

GLTFTOOL_API
void EmplaceGLTFPrimitiveVertexBufferAttribute(const cgltf_primitive* primitve, const char* semantics, uint32_t idx, skr::vector<uint8_t>& buffer, skr_vertex_buffer_entry_t& out_vbv);

// | prim0-indices | prim1-indices | prim2-indices | prim3-indices | ...
GLTFTOOL_API
void EmplaceAllGLTFMeshIndices(const cgltf_mesh* mesh, skr::vector<uint8_t>& buffer, skr::vector<skr_mesh_primitive_t>& out_primitives);

// | prim0-pos | prim1-pos | prim0-tangent | prim1-tangent | ...
GLTFTOOL_API
void EmplaceAllGLTFMeshVertices(const cgltf_mesh* mesh, const CGPUVertexLayout* layout, skr::vector<uint8_t>& buffer, skr::vector<skr_mesh_primitive_t>& out_primitives);

GLTFTOOL_API
void EmplaceSkinGLTFMeshVertices(const cgltf_mesh* mesh, const CGPUVertexLayout* layout, skr::vector<uint8_t>& buffer, 
    uint32_t buffer_idx, skr::vector<skr_mesh_primitive_t>& out_primitives);

GLTFTOOL_API
void EmplaceStaticGLTFMeshVertices(const cgltf_mesh* mesh, const CGPUVertexLayout* layout, skr::vector<uint8_t>& buffer, 
    uint32_t buffer_idx, skr::vector<skr_mesh_primitive_t>& out_primitives);
