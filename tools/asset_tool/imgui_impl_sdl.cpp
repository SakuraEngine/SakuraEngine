...
static bool ImGui_ImplSDL2_Init(SDL_Window* window, CGPUSwapChainId swapChain)
{
    ImGuiIO& io = ImGui::GetIO();
...
bool ImGui_ImplSDL2_InitForCGPU(SDL_Window* window, CGPUSwapChainId swapChain)
{
    return ImGui_ImplSDL2_Init(window, swapChain);
}

void ImGui_ImplSDL2_UpdateSwapChain(CGPUSwapChainId swapChain)
{
    ImGui_ImplSDL2_Data* bd = ImGui_ImplSDL2_GetBackendData();
    bd->swapChain = swapChain;
}
...
void ImGui_ImplSDL2_NewFrame()
{
    ...
    {
        const auto texInfo = bd->swapChain->back_buffers[0]->info;
        display_w = texInfo->width,
        display_h = texInfo->height;
    }
    else
