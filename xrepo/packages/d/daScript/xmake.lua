package("daScript")
    ...
    add_versions("2023.4.26-skr", "2506e12bada34dd369d07fc1cf5e5b7ee18eb4869241838996e02a5e07ad1f66")

    add_deps("daScriptCore 2023.4.26-skr")
    add_deps("daScriptTool 2023.4.26-skr")
