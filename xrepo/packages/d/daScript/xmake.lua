package("daScript")
    ...
    add_versions("2023.4.25-skr.9", "64bf3c12081a1324ac29a7cb104598e3e0fe628b574f30143c1038f66e26f21c")

    add_deps("daScriptCore 2023.4.25-skr.9")
    add_deps("daScriptTool 2023.4.25-skr.9")
