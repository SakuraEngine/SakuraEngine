package("daScript")
    ...
    add_versions("2023.4.25-skr.3", "78b4c890839abadc3c8db801dbf2d57ca642a7f55edc9b654eafb633ffefad65")

    add_deps("daScriptCore 2023.4.25-skr.3")
    add_deps("daScriptTool 2023.4.25-skr.3")
