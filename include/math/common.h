...
extern "C" {
#endif
FORCEINLINE static uint32_t smath_round_up_32(uint32_t value, uint32_t multiple)
{
...
FORCEINLINE static uint32_t smath_round_down_32(uint32_t value, uint32_t multiple) { return value - value % multiple; }
