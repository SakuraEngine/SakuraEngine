...
namespace dual
{
	...
	constexpr static dual_entity_t kEntityTransientVersion = ((1 << (sizeof(dual_entity_t) * 8 - ENTITY_VERSION_OFFSET)) - 1);
	...
	{
		return (e >> ENTITY_VERSION_OFFSET) & ENTITY_VERSION_MASK;
	}
	...
	{
		return ((value & ENTITY_VERSION_MASK) << ENTITY_VERSION_OFFSET) | e_id(e);
	}
