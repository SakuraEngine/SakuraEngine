...
using MultiMap [[sfinal_alias]] = container::MultiSparseHashMap<container::SparseHashMapMemory<
    K,                  /*Key Type*/
    V,                  /*Value Type*/
...
using FixedMultiMap [[sfinal_alias]] = container::MultiSparseHashMap<container::FixedSparseHashMapMemory<
    K,                 /*Key Type*/
    V,                 /*Value Type*/
    uint64_t,          /*BitBlock Type*/
...
using InlineMultiMap [[sfinal_alias]] = container::MultiSparseHashMap<container::InlineSparseHashMapMemory<
    K,                  /*Key Type*/
    V,                  /*Value Type*/
    uint64_t,           /*BitBlock Type*/
    HashTraits,         /*Hasher Traits*/
