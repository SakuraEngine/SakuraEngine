...
{
// basic enums
enum class [[sattr(guid = "26ff0860-5d65-4ece-896e-225b3c083ecb"
...
// flags
enum class [[sattr(guid = "3874222c-79a4-4868-b146-d90c925914e0"
...
enum class [[sattr(guid = "cf941db5-afa5-476e-9890-af836a373e73"
)]] ERTTRFunctionFlag : uint32_t
{
    None = 0,               // default
    ScriptVisible = 1 << 0, // can script visit this function
};
enum class [[sattr(guid = "42d77f46-f3e0-492d-b67f-f8445eff2885"
...
enum class [[sattr(guid = "52c78c63-9973-49f4-9118-a8b59b9ceb9e"
)]] ERTTRStaticMethodFlag : uint32_t
{
    None = 0,               // default
    ScriptVisible = 1 << 0, // can script visit this static method
};
enum class [[sattr(guid = "f7199493-29f5-4235-86c1-13ec7541917b"
)]] ERTTRExternMethodFlag : uint32_t
{
    None = 0,               // default
    ScriptVisible = 1 << 0, // can script visit this static method
};
enum class [[sattr(guid = "2f8c20d1-34b2-4ebe-bfd6-258a9e4c0c9e"
)]] ERTTRFieldFlag : uint32_t
{
    None = 0,               // default
    ScriptVisible = 1 << 0, // can script visit this field
};
enum class [[sattr(guid = "396e9de1-ce51-4a65-8e47-09525e91207f"
)]] ERTTRStaticFieldFlag : uint32_t
{
    None = 0,               // default
    ScriptVisible = 1 << 0, // can script visit this static field
};
enum class [[sattr(guid = "1f2aa88d-4d2f-47c0-8c97-b03cf574d673"
)]] ERTTRCtorFlag : uint32_t
{
    None = 0,
    ScriptVisible = 1 << 0, // can script visit this ctor
};
enum class [[sattr(guid = "a1497c67-9865-44cb-b81d-08c4e9548ae9"
...
enum class [[sattr(guid = "a2d04427-aa0a-43b4-9975-bc0e6b92120e"
)]] ERTTREnumItemFlag : uint32_t
{
    None = 0,               // default
    ScriptVisible = 1 << 0, // can script visit this enum item
};
enum class [[sattr(guid = "e76f7ad6-303d-4704-9065-827a7f6f270d"
...
//   method
//   static_method
struct [[sattr(guid = "982d9f4d-1c0f-4ee2-914a-b211f7539cff")]]
ScriptGetter
{
...
//   method
//   static_method
struct [[sattr(guid = "ee933720-6b10-4b03-a6e7-20227e4829b2")]]
ScriptSetter
{
