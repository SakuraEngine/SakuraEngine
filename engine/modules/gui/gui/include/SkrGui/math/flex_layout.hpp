...
enum class [[sattr(guid = "a87aa2f4-fafd-48cc-a224-8429f5bd771f"
...
enum class [[sattr(guid = "016b9be8-5d1d-476e-9078-ab8ea432f2b2"
...
enum class [[sattr(guid = "9ad7ec08-d31e-43eb-bb86-2dbecb34f130"
...
// Main axis 如何决定自己的尺寸
enum class [[sattr(guid = "4f356a69-c034-410a-a9e1-a8d7469d977e"
...
// Flex 的 Child 约束传递方式
enum class [[sattr(guid = "b8f94956-d449-430a-876e-243fda848d58"
)]] EFlexFit : uint8_t
{
    Tight, // min = max = max
    Loose, // min = 0.0f
