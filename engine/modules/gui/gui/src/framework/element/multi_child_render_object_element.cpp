...
void MultiChildRenderObjectElement::first_mount(NotNull<Element*> parent, Slot slot) SKR_NOEXCEPT
{
    ...
    auto multi_child_widget = widget()->rttr_cast<MultiChildRenderObjectWidget>();
    ...
    auto multi_child_render_object = render_object()->rttr_cast<IMultiChildRenderObject>();
...
void MultiChildRenderObjectElement::update(NotNull<Widget*> new_widget) SKR_NOEXCEPT
{
    ...
    _update_children(_children, widget()->rttr_cast<MultiChildRenderObjectWidget>()->children);
    auto multi_child_render_object = render_object()->rttr_cast<IMultiChildRenderObject>();
    multi_child_render_object->flush_updates();
}
...
{
    auto multi_child_render_object = render_object()->rttr_cast<IMultiChildRenderObject>();
    if (!child->rttr_is(multi_child_render_object->accept_child_type()))
    {
