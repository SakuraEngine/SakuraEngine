...
public class Command
{
    ...
    public void WriteHelp(CliWriter writer, string banner)
    {
...
public class CommandParser
{
    ...
    private bool _InvokeCommand(Command cmd, ParseContext ctx)
    {
        ...
        // check required options
        {
            ...
            HashSet<IOption> lostRequiredOptions = new();
            ...
            if (lostRequiredOptions.Count > 0)
            {
                ...
                ctx.Error($"These required options are missing: [{lostOptionsStr}]");
            }
        }
