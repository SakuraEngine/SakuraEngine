...
class PassProfiler : public skr::RG::RenderGraphProfiler
{
public:
    ...
    virtual void on_acquire_executor(class skr::RG::RenderGraph& g, class skr::RG::RenderGraphFrameExecutor& e)
    {
    ...
    virtual void on_cmd_begin(class skr::RG::RenderGraph& g, class skr::RG::RenderGraphFrameExecutor& executor)
    {
        query_cursor = 0;
        query_names.clear();
    ...
    virtual void on_cmd_end(class skr::RG::RenderGraph&, class skr::RG::RenderGraphFrameExecutor& executor)
    {
        cgpu_cmd_resolve_query(executor.gfx_cmd_buf, query_pool, query_buffer, 0, query_cursor);
    }
    virtual void on_pass_begin(class skr::RG::RenderGraph&, class skr::RG::RenderGraphFrameExecutor&, class skr::RG::PassNode& pass)
    {
    }
    virtual void on_pass_end(class skr::RG::RenderGraph&, class skr::RG::RenderGraphFrameExecutor& executor, class skr::RG::PassNode& pass)
    {
        CGPUQueryDescriptor query_desc = {};
        query_desc.index = query_cursor++;
    ...
    virtual void before_commit(class skr::RG::RenderGraph&, class skr::RG::RenderGraphFrameExecutor&) {}
    virtual void after_commit(class skr::RG::RenderGraph&, class skr::RG::RenderGraphFrameExecutor&) {}
