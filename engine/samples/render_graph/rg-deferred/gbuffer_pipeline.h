...
inline CGPURenderPipelineId create_gbuffer_render_pipeline(CGPUDeviceId device)
{
    ...
    read_shader_bytes(SKR_UTF8("rg-deferred/gbuffer.vs"), &vs_bytes, &vs_length, device->adapter->instance->backend);
    read_shader_bytes(SKR_UTF8("rg-deferred/gbuffer.fs"), &fs_bytes, &fs_length, device->adapter->instance->backend);
