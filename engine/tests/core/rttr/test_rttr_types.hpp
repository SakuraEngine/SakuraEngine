...
{
struct [[sattr(guid = "37aad92c-09f5-4e18-96ab-eea67094ea42")]]
AttrA
{
...
namespace test_rttr
{
struct [[sattr(guid = "c7925b0a-e4e7-4d67-b252-62b82a8da018")]]
BasicBaseA
{
};

struct [[sattr(guid = "d716b7bb-dd26-4eb3-b7a9-cdcc1e8994bc")]]
BasicBaseB
{
};

struct [[sattr(guid = "4619687b-71f2-4db6-b3b7-b25fcd63d3e0")]]
...
)]] BasicRecord : public BasicBaseAB
{
    ...
    [[sattr(
        rttr.flags = ["ScriptVisible"]
        rttr.attrs += `test_rttr::AttrA{u8"shit_field"}`
    )]]
    int32_t field_int32;
    bool field_bool;
    float field_float;
    ...
    [[sattr(
        rttr.flags = ["ScriptVisible"]
        rttr.attrs += `test_rttr::AttrA{u8"shit_method"}`
    )]]
    void method_a()
    {
    }
    ...
    [[sattr(
        rttr.flags = ["ScriptVisible"]
        rttr.attrs += `test_rttr::AttrA{u8"shit_static_field"}`
    )]]
    ...
    [[sattr(
        rttr.flags = ["ScriptVisible"]
        rttr.attrs += `test_rttr::AttrA{u8"shit_static_method"}`
    )]]
...
{
    A [[sattr(rttr.flags =["ScriptVisible"]; rttr.attrs += `test_rttr::AttrA{}`)]],
    B,
    C
};
...
{
    BasicEnum_A [[sattr(rttr.flags = ["ScriptVisible"]; rttr.attrs += `test_rttr::AttrA{}`)]],
        BasicEnum_B,
        BasicEnum_C
};

struct [[sattr(guid = "1fe7b9e0-4e08-40ff-a74d-ec8ed0c5a67b"; rttr = @disable)]]
DisableRTTR
{
};
