...
SKR_TYPE_INFO(OpTester, "7b3e54f1-1d3a-49f6-b15b-bfe439e14076")
...
TEST_CASE("test generic optional")
{
    ...
    // check address
    REQUIRE_EQ(&opt_bool.value_unchecked(), generic_opt_bool->value_ptr(&opt_bool));
    REQUIRE_EQ(&opt_int16.value_unchecked(), generic_opt_int16->value_ptr(&opt_int16));
    REQUIRE_EQ(&opt_int32.value_unchecked(), generic_opt_int32->value_ptr(&opt_int32));
    REQUIRE_EQ(&opt_int64.value_unchecked(), generic_opt_int64->value_ptr(&opt_int64));
    REQUIRE_EQ(&opt_float.value_unchecked(), generic_opt_float->value_ptr(&opt_float));
    REQUIRE_EQ(&opt_double.value_unchecked(), generic_opt_double->value_ptr(&opt_double));
    REQUIRE_EQ(&opt_guid.value_unchecked(), generic_opt_guid->value_ptr(&opt_guid));
